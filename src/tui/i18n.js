...
const en = {
  ...
  'digest.label': ' Digest (Enter open, n generate today, w generate this week, r review knowledge, Esc close) ',
  ...
  'digest.pendingOnOpen': (n) => `${n} folder(s) have knowledge ready to review — press d, then r`,
  'digest.reviewNone': 'No knowledge proposals waiting for review',
...
const ko = {
  ...
  'digest.label': ' 다이제스트 (Enter 열기, n 오늘 생성, w 이번주 생성, r 지식 검토, Esc 닫기) ',
  ...
  'digest.pendingOnOpen': (n) => `${n}개 폴더에 지식 업데이트가 준비됐어요 — d, r로 검토`,
  'digest.reviewNone': '검토할 지식 제안이 없습니다',
