...
const en = {
  ...
  'tutorial.step1Title': 'Step 1/13 — Organize',
  ...
  'tutorial.step4Title': 'Step 4/13 — Learn',
  'tutorial.step4Body': (fg) => `With \`backend/payments\` open, press {${fg}-fg}w{/} — Mycelium distills everything in it into one KNOWLEDGE.md.`,
  'tutorial.step5Title': 'Step 5/13',
  'tutorial.step5Body': (fg) => `Review the knowledge draft, then press {${fg}-fg}Enter{/} to save it. Next: see exactly what a new session here would inherit from it.`,
  'tutorial.step6Title': 'Step 6/13 — Reuse',
  'tutorial.step6Body': (fg) => `Press {${fg}-fg}c{/} to see the context a new session in this folder would inherit.`,
  'tutorial.step7Title': 'Step 7/13',
  'tutorial.step7Body': (fg) => `This is exactly what gets injected into a project's AGENTS.md automatically (or via {${fg}-fg}i{/} to do it for real). Press {${fg}-fg}q{/} to close.`,
  'tutorial.step8Title': 'Step 8/13 — Merge',
  ...
  'tutorial.step9Title': 'Step 9/13',
  'tutorial.step9Body': (fg) => `Type a title (or leave it blank for a default), then press {${fg}-fg}Enter{/}.`,
  'tutorial.step10Title': 'Step 10/13 — Split',
  ...
  'tutorial.step11Title': 'Step 11/13',
  'tutorial.step11Body': (fg) => `Press {${fg}-fg}*{/} to select all the proposed ranges, then {${fg}-fg}Enter{/} to apply.`,
  'tutorial.step12Title': 'Step 12/13',
  'tutorial.step12Body': (fg) => `You can also search everything with {${fg}-fg}/{/} or browse by date with {${fg}-fg}v{/}. Press {${fg}-fg}Enter{/} to continue.`,
  'tutorial.step13Title': 'Tutorial complete!',
...
const ko = {
  ...
  'tutorial.step1Title': '1/13단계 — 조직화',
  'tutorial.step1Body': (fg) => `아직 정리 안 된 세션 6개가 아래에 있습니다. {${fg}-fg}o{/}를 눌러 Mycelium이 내용을 읽고 폴더를 제안하게 해보세요.`,
  'tutorial.step2Title': '2/13단계',
  'tutorial.step2Body': (fg) => `제안된 폴더를 확인하고 {${fg}-fg}Enter{/}로 적용해보세요.`,
  'tutorial.step3Title': '3/13단계',
  'tutorial.step3Body': (fg) =>
    `폴더가 자동으로 생성되고 세션들이 정리됐습니다 — 결제 관련 세션 둘은 \`backend/payments\`로 함께 모였습니다. {${fg}-fg}↓{/}로 찾은 뒤 {${fg}-fg}Enter{/}/→로 열어보세요.`,
  'tutorial.step4Title': '4/13단계 — 학습',
  'tutorial.step4Body': (fg) => `\`backend/payments\`를 연 상태에서 {${fg}-fg}w{/}를 눌러보세요 — 그 폴더의 모든 세션을 하나의 KNOWLEDGE.md로 압축합니다.`,
  'tutorial.step5Title': '5/13단계',
  'tutorial.step5Body': (fg) => `지식 초안을 확인하고 {${fg}-fg}Enter{/}로 저장하세요. 다음: 새 세션이 여기서 무엇을 물려받는지 직접 확인해봅니다.`,
  'tutorial.step6Title': '6/13단계 — 재사용',
  'tutorial.step6Body': (fg) => `{${fg}-fg}c{/}를 눌러 이 폴더의 새 세션이 물려받을 컨텍스트를 확인해보세요.`,
  'tutorial.step7Title': '7/13단계',
  'tutorial.step7Body': (fg) => `이 내용이 그대로 프로젝트의 AGENTS.md에 자동 주입됩니다(또는 {${fg}-fg}i{/}로 직접 주입). {${fg}-fg}q{/}로 닫으세요.`,
  'tutorial.step8Title': '8/13단계 — 병합',
  'tutorial.step8Body': (fg) =>
    `이 두 세션은 사실 하나의 이야기입니다 — 조사, 그리고 수정. {${fg}-fg}Space{/}로 둘 다 선택한 뒤 {${fg}-fg}Shift+M{/}으로 하나의 연속된 기록으로 병합해보세요.`,
  'tutorial.step9Title': '9/13단계',
  'tutorial.step9Body': (fg) => `제목을 입력하거나(비워두면 기본값) {${fg}-fg}Enter{/}를 누르세요.`,
  'tutorial.step10Title': '10/13단계 — 분할',
  'tutorial.step10Body': (fg) =>
    `반대 방향도 완전히 되돌릴 수 있습니다. 병합된 세션은 {${fg}-fg}New{/}(미분류)로 이동했습니다 — 거기로 가서 선택한 뒤 {${fg}-fg}Shift+S{/}로 주제 경계 제안을 받아보세요.`,
  'tutorial.step11Title': '11/13단계',
  'tutorial.step11Body': (fg) => `{${fg}-fg}*{/}로 제안된 구간을 모두 선택한 뒤 {${fg}-fg}Enter{/}로 적용하세요.`,
  'tutorial.step12Title': '12/13단계',
  'tutorial.step12Body': (fg) => `{${fg}-fg}/{/}로 전체 검색, {${fg}-fg}v{/}로 날짜별 캘린더 보기도 가능합니다. {${fg}-fg}Enter{/}로 계속하세요.`,
  'tutorial.step13Title': '튜토리얼 완료!',
  'tutorial.step13Body': (fg) =>
