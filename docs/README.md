...
- [CLI](./cli.md). Every command, for scripting or running headless.
- [Architecture](./architecture.md). Data location, design principles, project status.
- [Feature catalog](./features.md). Every capability, its entry point, and its test coverage.
